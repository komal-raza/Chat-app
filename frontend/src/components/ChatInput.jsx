  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="px-4 w-full">
      <div className="relative w-full">
        <input
          type="text"
          className=" border text-sm rounded-lg block w-[190px] xs:w-[270px] md:w-[350px] lg:w-[400px] p-2.5 bg-gray-700 border-gray-600 text-white pr-8"
        ...
        <button
          type="submit"
          className="absolute inset-y-0 right-0 flex items-center sm:pr-4 "
        >
